...
def about_page():
    ...
    st.image("images/about/about_oval.jpg", width=200)
    st.write(
    ...
    st.image("images/about/about_heart.jpg", width=200)
    st.write(
    ...
    st.image("images/about/about_squre.jpg", width=200)
    st.write(
    ...
    st.image("images/about/about_round.jpg", width=200)
    st.write(
    ...
    st.image("images/about/about_oblong.jpg", width=200)
    st.write(
